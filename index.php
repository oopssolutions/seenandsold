  ...
  <div class="container">
    <div class="row align-items-center flex-column-reverse flex-md-row">
      <div class="col-lg-6 col-md-6 com-sm-12 col-12 mt-4 mt-lg-0 text-md-start text-center">
        ...
        <button
          type="button"
          class="btn btn-yellow px-4 py-2 mt-2"
    ...
    <div class="swiper brandSwiper">
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <div class="p-3">
            <div class="d-flex align-items-center">
              <img src="assets/img/google.webp" class="px-2 w-100" alt="Google" />
            </div>
          </div>
        </div>
        ...
        <div class="swiper-slide">
          <div class="p-3">
            <div class="d-flex align-items-center">
              <img src="assets/img/trello.webp" class="px-2 w-100" alt="Trello" />
            </div>
          </div>
        </div>
        ...
        <div class="swiper-slide">
          <div class="p-3">
            <div class="d-flex align-items-center">
              <img src="assets/img/monday.webp" class="px-2 w-100" alt="Monday" />
            </div>
          </div>
        </div>
        ...
        <div class="swiper-slide">
          <div class="p-3">
            <div class="d-flex align-items-center">
              <img src="assets/img/Notion.webp" class="px-2 w-100" alt="Notion" />
            </div>
          </div>
        </div>
        ...
        <div class="swiper-slide">
          <div class="p-3">
            <div class="d-flex align-items-center">
              <img src="assets/img/slack.webp" class="px-2 w-100" alt="Slack" />
            </div>
          </div>
        </div>
...
<section class="py-5" id="services">
  <div class="container">
    <p class="text-warning fw-semibold">WHAT WE DO</p>
    ...
    <div class="d-none d-lg-block">
      <div class="row g-4">
        <!-- Card Item -->
        <div class="col-md-4">
          <div class="service-border p-4 h-100">
            <div class="bg-warning d-inline-block p-3 rounded mb-3">
              <i class="fa fa-vector-square fs-4"></i>
            </div>
...
<section class="py-5" style="background-color: #f8fcf9">
  <div class="container">
...
<section class="py-5 bg-white">
  <div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
      <div>
        <span class="text-warning text-uppercase fw-bold small">Testimonials</span>
